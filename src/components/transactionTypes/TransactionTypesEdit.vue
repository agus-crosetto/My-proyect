...
<form class="row g-3" @submit.prevent="submitForm(selectedAccount)">
  ...
  <div class="col-md-4">
    <label for="inputSign" class="form-label">Sign</label>
    <input type="number" class="form-control" id="inputSign" v-model.trim="selectedAccount.sign" required>
  </div>
  <div class="col-6">
    <base-button type="submit">Update Transaction Type</base-button>
  </div>
  <div class="col-6">
    <base-button type="button" @click="cancelEdit">Back to Transaction Types</base-button>
  </div>
</form>
...
export default {
  ...
  methods:{
    ...
    cancelEdit(){
      const userWantsDelete = confirm(' Are you sure? This Transaction Type was left unedited!');
